...
GO
PRINT N'Avvio ricompilazione tabella [dbo].[DeviceInfo]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_DeviceInfo] (
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[DeviceInfo])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_DeviceInfo] ([Code], [TipoMacchina], [SensoDiMarcia], [Matricola], [Cliente], [CommessaNr], [DataCollaudo], [DataConsegna], [CompilatoDa], [Data], [TipoPC], [HardDisk], [RAM], [Grabber], [NumLed], [TipoLedD], [TipoLedN], [DistanzaIlluminatore], [Note1], [RealizzatoDa], [Data1], [QuadroRealDa], [NumSchemaEl], [installRealDa], [GruppoCont], [CollaudoRealDa], [Condizionatore], [Note2], [VerSWTilevision], [VerSWCalibroPlanar], [NumSensPlanar], [TipoSens], [NoteAggiuntive], [NomePC], [TipoCinghia], [LargCinghia], [TipoMotori], [TipoRiduttori], [TipoMarcatura], [Centratore], [MotoreMovTraverse], [TipoEncoder], [TipoAzionamenti], [MassimoFormato], [MinimoFormato], [TipoMotoriTLC], [AltezzaTlcN], [TipoTlcN], [TipoTlcD], [TipoObjN], [TipoObjD], [AperturaObjN], [AperturaObjD], [Note3], [MontaggioDa], [Data2])
        SELECT   [Code],
                 [TipoMacchina],
                 [SensoDiMarcia],
                 [Matricola],
...
EXECUTE sp_rename N'[dbo].[tmp_ms_xx_DeviceInfo]', N'DeviceInfo';
...
GO
PRINT N'Aggiornamento di Routine [dbo].[spDeviceInfo_Upsert]...';


GO
EXECUTE sp_refreshsqlmodule N'[dbo].[spDeviceInfo_Upsert]';
