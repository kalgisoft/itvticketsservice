...
GO
PRINT N'Modifica di Routine [dbo].[spLog_List]...';


GO
ALTER PROCEDURE [dbo].[spLog_List]
--No parameters required.
AS
BEGIN
--SQL for Select stored procedure.
SELECT LogId, LogLevel, EventName, Source, ExceptionMessage, StackTrace, CreatedDate, UserId FROM LogTable ORDER BY CreatedDate DESC
END
GO
